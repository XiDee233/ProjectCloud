...
{    
	...
	public class MMF_MMSoundManagerSound : MMF_Feedback
	{
		...
		[Tooltip("alternatively, instead of an audio clip you can specify an AudioResource, in which case the Sfx above will be ignored, and the AudioResource will be used")]
		[MMFEnumCondition("Source", (int)Sources.AudioClip)]
		public UnityEngine.Object AudioResourceToPlay;
#endif
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			if (Sfx != null)
			{
				PlaySound(Sfx, position, intensityMultiplier, null);
			}
#endif
		}
		...
		protected virtual void PlaySound(AudioClip sfx, Vector3 position, float intensity, UnityEngine.Object audioResource = null)
		{
...
#else
			PlayAudioSource(_editorAudioSource, tmpAudioClip, volume, pitch, _randomPlaybackTime, _randomPlaybackDuration, null);
#endif
			_lastPlayTimestamp = FeedbackTime;
		...
		protected virtual void PlayAudioSource(AudioSource audioSource, AudioClip sfx, float volume, float pitch, float time, float playbackDuration, UnityEngine.Object audioResourceToPlay)
		{
